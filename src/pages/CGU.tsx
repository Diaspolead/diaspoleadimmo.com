        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none space-y-6 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p>
                Vous avez le droit de publier les commentaires sur notre site web et disposez de toutes les licences et autorisations nécessaires à cet effet.
              </p>
              <p>
                Les commentaires n'enfreignent aucun droit de propriété intellectuelle, y compris, mais sans s'y limiter, les droits d'auteur, les brevets ou les marques déposées d'un tiers.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                Les agences gouvernementales ; les moteurs de recherche; Organismes de presse ; Les distributeurs d'annuaires en ligne peuvent établir un lien avec notre site web de la même manière qu'ils établissent un lien hypertexte avec les sites web d'autres entreprises répertoriées ; et Les entreprises accréditées à l'échelle du système, à l'exception des organisations à but non lucratif, des centres commerciaux caritatifs et des groupes de collecte de fonds caritatifs, qui ne peuvent pas établir de lien hypertexte avec notre site web.
              </p>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Suppression de liens sur notre site web :</h2>
              <p>
              ...
              <p>
                Nous ne garantissons pas l'exactitude des informations figurant sur ce site web. Nous ne garantissons pas leur exhaustivité ou leur exactitude, et nous ne nous engageons pas non plus à garantir que le site web reste disponible ou que le matériel qu'il contient soit tenu à jour.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Limiter ou exclure notre ou votre responsabilité en cas de décès ou de dommages corporels ; Limiter ou exclure notre ou votre responsabilité en cas de fraude ou de déclaration frauduleuse ; Limiter une quelconque de nos ou de vos responsabilités d'une manière qui n'est pas autorisée par la loi applicable ; ou Exclure l'une de nos ou de vos responsabilités qui ne peut être exclue en vertu de la loi applicable.
              </p>
              <p>
