...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      features: ['Vérification des titres de propriété', 'Accompagnement à l\'acquisition de document légal : plan cadastre, bail, demande de permis de construire, titre foncier etc.'],
    ...
    },
    {
      ...
      color: 'bg-brand-blue',
      image: '/lovable-uploads/6dfc2028-afd0-43d8-b46f-6c2aaa2187cc.png'
    },
    {
      icon: Key,
